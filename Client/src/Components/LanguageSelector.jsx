    ...
    <div className="language-selector ms-2">
      <Dropdown as={ButtonGroup}>
        <Dropdown.Toggle
          variant="white"
          size="sm"
          className="d-flex align-items-center gap-2 px-2 py-1 px-sm-3 py-sm-2 rounded-pill shadow-sm border-2 lang-toggle-btn"
        >
          {/* Replaced FontAwesomeIcon with your SVG */}
          <svg
            viewBox="0 0 24 24"
            role="img"
         ...
         C8,16.2424242 9.33333333,19.5757576 12,22 Z"
          ...
          <span className="lang-label d-none d-sm-inline">
